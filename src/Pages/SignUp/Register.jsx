      ...
      <form className="mt-6" onSubmit={handleSubmit(onSubmit)}>
        <div className="my-3" onChange={handelRole}>
          <div className="flex items-center gap-1">
            <input required type="radio" name="v" value="Customer" />
            <span className="text-lg font-bold">Customer</span>
          </div>
          <div className="flex items-center gap-1">
            <input required type="radio" name="v" value="Seller" />
        ...
        <div className={role ? "hidden" : "my-3"}>
          ...
          <select
            ...
            className="select select-bordered block w-full px-4 py-3 mt-2 text-gray-700 bg-white border rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 "
          >
        ...
        <div className="mt-4 relative">
          ...
          {errors.password && (
            <p className="text-red-600">Please provide a strong password</p>
          )}
        </div>
        <div className="mt-4">
          <div className="flex items-center justify-between">
            <label for="photo" className="block text-gray-800 font-medium">
              Photo
            </label>
          </div>
          <input
            ...
            {...register("photo")}
            type="file"
            className="file-input file-input-bordered w-full mt-2 max-w-xs"
          />
        </div>
        <div className="mt-6">
