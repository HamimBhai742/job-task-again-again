            ...
            <div className="max-w-7xl mx-auto">
                        ...
                        >
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-3xl font-bold text-white">{animatedItems}</p>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-3xl font-bold text-white">${animatedTotal.toFixed(2)}</p>
                                </div>
                            </div>
                        </motion.div>
                            ...
                            >
                                <div className="flex flex-col lg:flex-row items-center space-y-4 lg:space-y-0 lg:space-x-6">
                                    ...
                                    <div className="flex-1 text-center lg:text-left">
                                        ...
                                        <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-2 sm:space-y-0 sm:space-x-4">
                                            <div className="flex items-center space-x-2 bg-white/10 rounded-full px-4 py-2">
                                                ...
                                                <span className="text-green-400 font-semibold">${myCart?.productPrice.toFixed(2)}</span>
                                            </div>
                                            <div className="flex items-center space-x-2 bg-white/10 rounded-full px-4 py-2">
                                                <span className="text-white/70 text-sm">Qty:</span>
                                                <span className="text-blue-400 font-semibold">{myCart?.productQuantity}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <motion.button
                                            onClick={() => handelDeleteBtn(myCart?._id, myCart?.productId)}
                                            whileHover={{ scale: 1.1 }}
                                            whileTap={{ scale: 0.9 }}
                ...
                >
                    ...
                    <div className="text-center">
                        <p className="text-white/70 text-sm mb-2">Secure checkout with SSL encryption</p>
                        <div className="flex items-center justify-center space-x-2">
                            <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                            <span className="text-green-400 text-sm font-medium">Safe & Secure</span>
                        </div>
                    </div>
                </motion.div>
            </div>
