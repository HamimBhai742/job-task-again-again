...
const Products = () => {
  ...
  console.log(cateGory,cateGorySta);
  ...
  return (
    <div className="lg:mx-10 md:mx-5 mx-3">
          ...
          >
            <form onSubmit={handelCategorization}>
              ...
              <input
                ...
                className="input input-bordered w-full max-w-28 ml-3"
                name="maxPrice"
                type="number"
              />
              <div className="mt-5">
      ...
      {products.length > 0 ? (
        ...
        <>
          <div>
            <p className="flex min-h-72 justify-center items-center text-3xl font-bold">
              No Data Found
            </p>
          </div>
        </>
      ...
      {products.length > 0 ? (
        <div className="flex md:gap-5 gap-3 justify-center items-center my-10">
          <button
            ...
            className="md:btn md:btn-info max-sm:bg-info max-sm:p-2 max-sm:rounded-lg"
          >
            Prev
          </button>
          <p>
            {pages.map((p) => (
              <button
                ...
                className={
                  currentPage === p
                    ? "md:btn md:btn-secondary md:btn-circle ml-2 max-sm:bg-secondary max-sm:h-7 max-sm:w-7 max-sm:rounded-full"
                    : "md:btn ml-2 md:btn-circle md:btn-success max-sm:bg-success max-sm:h-7 max-sm:w-7 max-sm:rounded-full"
                }
              >
                {p + 1}
              </button>
          ...
          <button
            ...
            className="md:btn md:btn-accent max-sm:bg-accent max-sm:p-2 max-sm:rounded-lg"
          >
            Next
          </button>
          <select
            className="md:border-2 md:border-blue-500 rounded-md px-2"
