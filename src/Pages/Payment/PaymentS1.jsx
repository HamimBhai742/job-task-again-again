      ...
      <div className="bg-gray-100 max-w-[700px] p-10 mx-auto">
        <div className="flex flex-col gap-3" onChange={handelShippingBtn}>
          ...
          <div
            className={
              shipping === "inDhaka"
                ? "border-2 border-gray-700 rounded-md p-3 flex justify-between items-center"
                : "border border-gray-400 rounded-md p-3 flex justify-between items-center"
            }
          >
            <div>
        ...
        >
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full mt-1 h-12 pl-10 rounded-md bg-white border-[1px] border-gray-400"
            />
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-2">
              ...
              <div className="relative">
                ...
                <select
                  {...register("state")}
                  className="w-full mt-1 h-12 px-3 rounded-md bg-white border-[1px] border-gray-400"
                >
                  <option disabled selected>
                    State
                  </option>
                  <option
                    disabled={shipping === "inDhaka" ? false : true}
                    value="Dhaka"
                  >
                    Dhaka
                  </option>
                  <option
                    disabled={shipping === "inDhaka" ? true : false}
                    value="Chattogram"
                  >
                    Chattogram
                  </option>
              ...
              <div className="relative">
                <input
                  ...
                  type="text"
                  placeholder="ZIP"
                  className="w-full mt-1 h-12 pl-3 rounded-md bg-white border-[1px] border-gray-400"
                />
                {errors.ZIP && (
                  <p role="alert" className="text-red-600 text-sm">
                    ZIP code only number{" "}
                  </p>
                )}
              </div>
            </div>
          ...
          <hr />
          <div>
            <h4 className="flex items-center justify-between text-lg font-semibold">
              Subtotal <span>${subTotalPrice}</span>
            </h4>
            <h4 className="flex items-center justify-between text-lg font-semibold mt-1">
              Shipping <span>${shippingCrarge}</span>
            </h4>
          </div>
          <hr />
          <div>
          ...
          <div>
            <button
              className={
                plcBtn ? "w-full btn btn-info" : "w-full btn btn-disabled"
              }
            >
              {loading ? (
